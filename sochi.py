...
def avg_medal_count():
    ...
    #avg_medal_count = df[ medal_count >= 10 ][ ['gold', 'silver', 'bronze'] ].apply( numpy.mean )

    #df['won_five_of_each'] = df.gold >= 5 and df.silver >= 5 and df.bronze >= 5

    print df[ ['country_name', 'points'] ].sort( 'points', ascending = 0 )
    ...
    #print df[ medal_count >= 10 ][ ['gold', 'silver', 'bronze'] ].describe()

    #print numpy.mean( df[ df.gold >= 1 ].bronze )
